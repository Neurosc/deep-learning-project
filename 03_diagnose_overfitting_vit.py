...
Default diagnostic condition:
    target = ViT-L-14__block24
    window = 100_200 ms
    seed   = 0

This keeps the EEG window, seed, epochs, optimizer, and two decoder controls
identical to the RN50 diagnostic so the comparison is as clean as possible.
...
OUT_CSV = os.path.join(RES_DIR, "diagnose_overfitting_vit_sub-01.csv")
SUMMARY_CSV = os.path.join(RES_DIR, "diagnose_overfitting_vit_summary_sub-01.csv")
